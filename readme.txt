### Here are my web 3 notes and my journey using Harkirat's cohort. 

Imp Points :--- 

[Day - 1 ] ---> [ https://projects.100xdevs.com/tracks/web3-orientation/Web3-Cohort---Orientation-1 ]

-- We are learning blockchain and why we need them and leading to bitcoin and other web3 stuff. 
1. Hashing --- It is not encryption, it is converting a given input into some random string which is sort of irreversible .
